...
export type askOptionsType = {
  answerOnly?: boolean; // return only answer, default true
  language?: string; // Answer in ${language} language.
  context?: string; // In ${context} context.
  ...
  format?: // Response in ${format} format
    'plain text'
    | 'JSON'
    | 'HTML'
    | 'XML'
